        ...
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              If turned on, we are allowing callers to interrupt the assistant while the assistant is
              speaking. Once interrupted the assistant will stop speaking and listen to what the
              caller is saying.
            </p>
          </div>
          <Switch
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              Enable this setting to allow the assistant to re-engage with the user if the user has
              not responded.
            </p>
          </div>
          <Switch
